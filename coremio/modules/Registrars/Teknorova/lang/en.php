...
return [
    'name'              => 'Teknorova',
    'description'       => 'With Teknorova.com, one of the popular domain name registrars, all domain name transactions can be made instantaneously through the domain API. To do this, define your Teknorova.com client account information in the following fields.',
